...
export const TS_RUNTIME_MODULES = [
  {
    ...
    globalExports: [
      ...
      // the redeclaration is a SyntaxError that kills the whole page script.
      // Those callers use SharedUtils.getDomainRoot(...) instead.
      'formatBytes',
    ],
  ...
  {
    id: 'organization-action-handler',
    source: 'src/background/organization-action-handler.ts',
    output: 'modules/organization-action-handler.js',
    exportName: 'OrganizationActionHandler',
  ...
  {
    id: 'script-action-handler',
    source: 'src/background/script-action-handler.ts',
    output: 'modules/script-action-handler.js',
    exportName: 'ScriptActionHandler',
    selfExportName: 'ScriptActionHandler',
  },
  {
    id: 'data-action-handler',
    source: 'src/background/data-action-handler.ts',
    output: 'modules/data-action-handler.js',
    exportName: 'DataActionHandler',
