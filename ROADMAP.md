...
>
> **Roadmap version:** Round 40 - Monaco ESM browser smoke 2026-06-06.
...
- **Acceptance for next implementation slice:** Add a dashboard-level Chromium editor smoke: open the dashboard editor, wait for `editor.isMonaco === true`, edit and save a script, reload, and confirm persistence through the Monaco adapter path.
...
- **Current cycle:** Round 40 Cycle 78 added Chromium extension-page ESM sandbox smoke coverage for the ready path and missing-bundle fallback path.
- **Next implementation angle:** Cycle 79 should continue X-4 with a dashboard-level Monaco adapter smoke: create/open a script in the dashboard editor, prove `editor.isMonaco === true`, edit/save through the adapter, reload, and confirm persistence.
