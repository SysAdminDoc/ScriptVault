...
- [x] P1 — Continue TypeScript authoritative-source promotion until `background.core.js` is generated from TS
  - Why: runtime/TS mirror drift is collapsed for the existing concatenated build. `ts-source-promotion.json` now tracks 25 promoted entries, 0 mirrored entries, and 0 intentionally divergent runtime files.
