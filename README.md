...
_Last generated: 2026-07-02 with `npm run support:matrix`. Version source: `manifest.json` / `manifest-firefox.json` 3.13.0._
...
<p align="center">
  <strong>ScriptVault v3.13.0</strong><br>
