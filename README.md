...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.27.0-22c55e?style=flat-square" alt="Version">
...
_Last generated: 2026-08-08 with `npm run support:matrix`. Version source: `manifest.json` / `manifest-firefox.json` 3.27.0._
...
| Brave / Vivaldi / Opera / Arc | Chromium derivative local-smoke targets | Chrome 130+ compatible package | Not release-verified | `npm run smoke:derivatives`, `chromium-derivative-artifacts/summary-3.27.0.json` | store policy, shields/sidebar behavior, and extension UI chrome remain browser-specific |
...
<p align="center">
  <strong>ScriptVault v3.27.0</strong><br>
