...
- [x] F-1 TypeScript authoritative-source promotion complete for runtime artifacts: `background.core.js` is generated from `src/background/core.ts`; after the later Sigstore parser promotion, the current promotion gate reports 24 promoted entries, 0 mirrored entries, and 0 intentionally divergent runtime files — *Source: docs/archive/TODO.md Phase F; commit feat: promote background core runtime*
