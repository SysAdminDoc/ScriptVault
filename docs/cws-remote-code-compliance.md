...
| Sandboxed editor page | sandboxed editor page | `pages/editor-sandbox.html`, `pages/monaco-adapter.js` | Monaco loads from packaged `lib/monaco-esm/` assets. The sandbox page has no extension API access and is isolated by the manifest `sandbox` declaration. |
