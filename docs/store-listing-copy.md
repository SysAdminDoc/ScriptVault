...
AMO source-review build instructions, unlisted-first submission steps, and the short reviewer rationale live in `AMO-SOURCE-README.md`, which is included in the source-review ZIP generated by `npm run firefox:package`.
