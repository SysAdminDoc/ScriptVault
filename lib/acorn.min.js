...
`;case 114:return"\r";case 120:return String.fromCharCode(this.readHexChar(2));case 117:return B(this.readCodePoint());case 116:return"	";case 98:return"\b";case 118:return"\v";case 102:return"\f";case 13:this.input.charCodeAt(this.pos)===10&&++this.pos;case 10:return this.options.locations&&(this.lineStart=this.pos,++this.curLine),"";case 56:case 57:if(this.strict&&this.invalidStringToken(this.pos-1,"Invalid escape sequence"),e){var i=this.pos-1;this.invalidStringToken(i,"Invalid escape sequence in template string")}default:if(t>=48&&t<=55){var s=this.input.substr(this.pos-1,3).match(/^[0-7]+/)[0],r=parseInt(s,8);return r>255&&(s=s.slice(0,-1),r=parseInt(s,8)),this.pos+=s.length-1,t=this.input.charCodeAt(this.pos),(s!=="0"||t===56||t===57)&&(this.strict||e)&&this.invalidStringToken(this.pos-1-s.length,e?"Octal literal in template string":"Octal literal in strict mode"),String.fromCharCode(r)}return q(t)?(this.options.locations&&(this.lineStart=this.pos,++this.curLine),""):String.fromCharCode(t)}},x.readHexChar=function(e){var t=this.pos,i=this.readInt(16,e);return i===null&&this.invalidStringToken(t,"Bad character escape sequence"),i},x.readWord1=function(){this.containsEsc=!1;for(var e="",t=!0,i=this.pos,s=this.options.ecmaVersion>=6;this.pos<this.input.length;){var r=this.fullCharCodeAtPos();if(O(r,s))this.pos+=r<=65535?1:2;else if(r===92){this.containsEsc=!0,e+=this.input.slice(i,this.pos);var n=this.pos;this.input.charCodeAt(++this.pos)!==117&&this.invalidStringToken(this.pos,"Expecting Unicode escape sequence \\uXXXX"),++this.pos;var u=this.readCodePoint();(t?L:O)(u,s)||this.invalidStringToken(n,"Invalid Unicode escape"),e+=B(u),i=this.pos}else break;t=!1}return e+this.input.slice(i,this.pos)},x.readWord=function(){var e=this.readWord1(),t=a.name;return this.keywords.test(e)&&(t=ae[e]),this.finishToken(t,e)};var mt="8.17.0";C.acorn={Parser:C,version:mt,defaultOptions:re,Position:z,SourceLocation:J,getLineInfo:ye,Node:te,TokenType:v,tokTypes:a,keywordTypes:ae,TokContext:V,tokContexts:b,isIdentifierChar:O,isIdentifierStart:L,Token:de,isNewLine:q,lineBreak:w,lineBreakG:Te,nonASCIIwhitespace:be};function Jt(e,t){return C.parse(e,t)}function $t(e,t,i){return C.parseExpressionAt(e,t,i)}function ei(e,t){return C.tokenizer(e,t)}g.Node=te,g.Parser=C,g.Position=z,g.SourceLocation=J,g.TokContext=V,g.Token=de,g.TokenType=v,g.defaultOptions=re,g.getLineInfo=ye,g.isIdentifierChar=O,g.isIdentifierStart=L,g.isNewLine=q,g.keywordTypes=ae,g.lineBreak=w,g.lineBreakG=Te,g.nonASCIIwhitespace=be,g.parse=Jt,g.parseExpressionAt=$t,g.tokContexts=b,g.tokTypes=a,g.tokenizer=ei,g.version=mt}));
